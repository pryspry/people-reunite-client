<template>
    <q-page class="q-pa-md">
        <h1 class="ppl_kategorititle text-h5">
            <q-icon name="fas fa-feather-alt"/> Feature Story
        </h1>
...
import { featureNaskahsQuery } from 'src/graphql/queries.js'

export default {
    name: 'PageIndex',
    meta: {
        title: 'Feature Story - People Reunite',
            meta: {
                ...
                ogTitle: {property: 'og:title', content: 'Feature Story - People Reunite'},
                ...
                twitterTitle: {property: 'twitter:title', content: 'Feature Story - People Reunite'},
